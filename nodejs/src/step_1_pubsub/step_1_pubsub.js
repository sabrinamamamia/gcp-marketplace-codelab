...
var SUBSCRIPTION_NAME = 'masabrina-codelab';
function main() {
    return __awaiter(this, void 0, void 0, function () {
        var pubsub, subscription, messageHandler;
        return __generator(this, function (_a) {
            pubsub = new pubsub_1.PubSub({ projectId: GOOGLE_CLOUD_PROJECT });
            ...
            subscription.on('error', function (error) { console.log(error); });
            return [2 /*return*/];
        });
    });
}
